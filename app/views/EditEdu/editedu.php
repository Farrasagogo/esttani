        ...
        <div class="col-md-10 mx-auto">
          <div class="card">
            <div class="card-header text-bg-light">
              <span>Edukasi</span>
              <a href="TambahEdu" class="btn btn-sm btn-secondary">Tambah</a>
            </div>
            <div class="card-body">
              <table class="table">
                <thead>
                ...
                <tbody>
                    <?php foreach ($data['edukasi'] as $listeddata): ?>
                    <tr>
                        <td><?php echo $listeddata['id']; ?></td>
                        <td>
                            <p>
                            <img src="<?php echo $listeddata['gambar']; ?>" alt="" width="70px" height="70px" />
                            </p>
                        </td>
                        <td><?php echo $listeddata['judul']; ?></td>
                        <td>
                            <span class="badge bg-success"><i class="fas fa-tags"></i> <?php echo $listeddata['kategori']; ?></span>
                        </td>
                        <td>
                            <form action="EditEdu" method="post">
                            <input type="hidden" name="idedu" value="<?php echo $listeddata['id']; ?>">
