        ...
        <div class="col-md-10 mx-auto">
          <div class="card">
            <div class="card-header text-bg-light">
              <span>Produk</span>
              <a href="TambahBarang" class="btn btn-sm btn-secondary">Tambah</a>
            </div>
            <div class="card-body">
              <table class="table">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <img src="<?php echo $barang['gambar']; ?>" alt="" width="20px" height="20px" />
                        ...
                        <td>
                            ...
                            <input type="hidden" name="idbarang" value="<?php echo $barang['id']; ?>">
                                ...
                                <button class="btn btn-sm" name="hapus" onclick="return confirm('Apa anda yakin?')">
