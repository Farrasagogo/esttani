...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    ...
    <?php foreach ($data['transactions'] as $transaction): ?>
      <tr>
        <td>
          <a href="detail_transaksi.php?id=<?php echo $transaction['id']; ?>"><strong>#<?php echo $transaction['id']; ?></strong></a>
        </td>
        <td><?php echo $transaction['waktu_transaksi']; ?></td>
        <td><?php echo 'Rp' . number_format($transaction['total'], 0, ',', '.') ?></td>
        <td>
          <span class="badge bg-warning"><?php echo $transaction['status']; ?></span>
        </td>
      </tr>
    <?php endforeach; ?>
  </tbody>
