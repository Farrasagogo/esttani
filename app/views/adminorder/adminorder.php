            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu bg" aria-labelledby="dropdown-1">
                ...
                <a href="admin-user.html" class="dropdown-item text-success"
                  >Pengguna</a
                >
                <a href="admin-edu.html" class="dropdown-item text-success"
                  >Edukasi</a
                >
              </div>
            </li>
      ...
      <div class="row">
        <div class="col-md-10 mx-auto">
          <div class="card">
            ...
            <tr>
                <td>
                    <a href=""><strong>#<?php echo $transaction['id']; ?></strong></a>
                </td>
                <td><?php echo $transaction['waktu_transaksi']; ?></td>
                <td>Rp<?php echo number_format($transaction['total'], 0, ',', '.'); ?></td>
                <td>
                <form action="AdminTransactionController" method="POST">
                    <input type="hidden" name="transaction_id" value="<?php echo $transaction['id']; ?>">
                    <select name="new_status">
                    <?php
                    $statusOptions = ['Menunggu Pembayaran', 'Diproses', 'Selesai']; // Define the available status options
                    foreach ($statusOptions as $option) {
                        $selected = ($option === $transaction['status']) ? 'selected' : '';
