<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>/css/edu.css" />
  </head>
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light fixed-top bg-success">
      <div class="container">
        <a class="navbar-brand text-bg-success" href="#">Edu Tani</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="Home" class="nav-link text-bg-success"
                >Home</a
              >
            </li>
            <li class="nav-item">
              <a href="Edu" class="nav-link text-bg-success">Edukasi</a>
            </li>
            <li class="nav-item">
              <a href="BarangList" class="nav-link text-bg-success"
                >Belanja</a
              >
            </li>
            <li class="nav-item">
              <a href="Login" class="nav-link text-bg-success"
                >Login</a
              >
            </li>
          </ul>
    ...
    <?php $idToPass = ''; // Variable to store the clicked edu ID
            ...
            <div class="content">
                ...
                <form action="Edu" method="post">
                    <div class="styled-button">
                        ...
                        <button type="submit" name="edudetail" class="btn">
                            <div class="span"></div>
                            <p>Lihat Detail</p>
                        </button>
                    </div>
    ...
    <?php } ?>
      ...
      <div id="load-more"><div class="span"></div>Load More</div>
    </div>
