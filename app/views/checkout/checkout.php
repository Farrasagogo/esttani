          ...
          <div class="card">
            ...
            <form action="CheckoutController" method="post">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control mt-1" name="name" placeholder="Masukan Nama Penerima" required />
                  <small class="form-text text-success">Nama Harus Diisi.</small>
              </div>
              <div class="form-group mt-3">
                  <label for="">Alamat</label>
                  <textarea name="address" cols="30" rows="5" class="form-control mt-1" required></textarea>
                  <small class="form-text text-success">Alamat Harus Diisi.</small>
              </div>
              <div class="form-group mt-3">
                  <label for="">Telepon</label>
                  <input type="text" class="form-control mt-1" name="phone" placeholder="Masukan No Telepon Penerima" required />
                  <small class="form-text text-success">Nomor Telepon Harus Diisi.</small>
              </div>
              ...
              <div class="card mb-3">
                    ...
                    <tbody>
                      ...
                      $totalPrice= 0; 
                        $totalPrice += $item['subtotal']; ?>
                          <tr>
                              <td name="nama_barang"><?php echo $item['nama_barang']; ?></td>
                              <td name="quantity" class="text-center"><?php echo $item['jumlah_barang']; ?></td>
                              <td name="subtotal">Rp<?php echo number_format($item['subtotal'], 0, ',', '.'); ?>,-</td>
                          </tr>
                      <?php endforeach; ?>
                  </tbody>
                    <tfoot>
                ...
                <div class="card-footer">
                  <a href="cart.html" class="btn btn-warning text-white"
                    ><i class="fas fa-angle-left"></i> Kembali Ke Cart</a
                  >
                </div>
              </div>
            </div>
