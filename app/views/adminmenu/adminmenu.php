...
<html lang="en" data-bs-theme="auto">
  ...
  <body style="background: url(img/track.jpg);
    ...
    <main class="container conten3">
      <div class="row">
        <div class="col-md-8 mx-auto">
          <div class="card">
            <div class="card-header text-bg-success">Pilih Menu Admin</div>
            <div class="card-body">
              <form action="" class="">
                <a href="EditEdu" class="btn btn-success text-center col-md-12 mt-md-3">
                  Edit Edukasi
                </a> <br><br>
                <a href="admin-produk.html" class="btn btn-success text-center col-md-12 mt-md-2">
                    Edit Shop 
                </a>
              </form>
            </div>
