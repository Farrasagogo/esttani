  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light fixed-top bg-success">
      <div class="container">
        ...
        <img src="img/Logo_Edutani-removebg-preview.png" class="logo m-lg-2" />
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item">
              <a href="edu.html" class="nav-link text-bg-success"
                >Edukasi</a
              >
            </li>
          </ul>
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="index.html" class="nav-link text-bg-success"
                >Beranda</a
              >
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown-2">
                <a href="profile.html" class="dropdown-item text-success"
                  >Profile</a
                >
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <p>Nama: Faith</p>
                  <p>Email: FaithWaluyo@gmail.com</p>
                  <a href="edit-profile.html" class="btn btn-success">Edit</a>
                </div>
              </div>
            </div>
          </div>
